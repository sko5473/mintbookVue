      ...
      <div id="divide_section">
        <div id="category">
          ...
          <ul v-for="tmp of state.categorylist" :key="tmp">
            <li id="category_list">
              <a href="/bestseller">{{ tmp }}</a>
            </li>
          </ul>
        </div>
        <div id="booklist">
          <ul class="maintitle_wrap">
            <li><img src="../assets/MainPage/new.png" alt="" /></li>
            <li id="maintitle">이 주의 신간</li>
          </ul>
          <table>
            <tr>
              <th>
            ...
            >
              ...
              <td id="price_wrap">
                ...
                <div id="description">
                  2000년부터 발표된 그의 주옥같은 글들, 독자들이 자발적으로 만든
                  제본서는 물론, 전자책과 앱까지 나왔던 세이노의 가르침이 드디어
                  전국 서점에서 독자들을 마주한다. 여러판본을 모으고2000년부터
                  발표된 그의 주옥같은 글들, 독자들이 자발적으로 만든 제본서는
                  물론, 전자책과 앱까지 나왔던 전국 서점에서 독자들을 마주한다.
                  여러판본을 모으고2000년부터 발표된 그의 주옥같은 글들,
                  독자들이 자발적으로 만든 제본서는 물론, 전자책과 앱까지 나왔던
                  세이노의 가르침이 드디어 전국 서점에서 독자들을 마주한다.
                  여러판본을 모으고2000년부터 발표된 그의 주옥같은 글들,
                  독자들이 자발적으로 만든 제본서는 물론, 전자책과 앱까지 나왔던
                  전국 서점에서 독자들을 마주한다. 여러판본을 모으고
                </div>
              </td>
